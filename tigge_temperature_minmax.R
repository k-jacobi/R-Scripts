...
# 'step'    : "6/to/366/by/6" 
# 'param'   : "121, 122" - maximum, minimum temperature (of preceding 6 hour period)
# show individual forecast series
# script version 2012-01-25 
...
pntFile <- "Mangla.pnt"
TiggeOutput <- "2006_ecmf_tmp_mima" # change the file name (without file extension)!
#egrr # UK met office
#cwao # Canada
#ncep # NCEP USA
#ecmf # ECMF Europe
npt <- 6 # number of points to probe
nday <- 4 # number of observations per day
p1 <- 1 ; p2 <- 15 # reduce overlap (forecast days) of plotting
tf <- "temp_interpol.txt" # verfication data, temperature
oro.f <- "ncep_oro.prb" # altitudes of cells
