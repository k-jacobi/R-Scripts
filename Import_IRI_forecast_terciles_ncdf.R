...
xp0 <- 102 # precipitation
yp0 <- 23 # precipitation
xp0 <- 127 # temperatures
yp0 <- 28 # temperatures
f0 <- 26 # March 2002 for precipitation
f0 <- 25 # March 2002 for temperatures
...
theDate_i <- function(m, m0) { # enter serial number of month in netCDF
    ...
    #m0 <- m0+m+29 # note: first 16 numbers are in 3-month intervals for precipitation
